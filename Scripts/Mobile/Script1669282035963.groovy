...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Accessibility (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Accessibility Node Provider (1)'), 0)
